...
async function main() {
  console.log('=== POPULARIZACAO 5K REGISTROS ===\n');
  ...
  // ============================================================
  console.log('=== 1. Gerando inscricoes (~770) ===');
  ...
  // ============================================================
  console.log('=== 2. Gerando matriculas (~470) ===');
  ...
  // ============================================================
  console.log('=== 3. Gerando historico escolar (~1000) ===');
  ...
  for (let i = 0; i < 1000 && mats.length > 0; i++) {
  ...
  // ============================================================
  console.log('=== 4. Gerando frequencia (~1000) ===');
  batch = [];
  let totalFreq = 0;
  ...
  // 5. RECLAMACOES (~85)
  // ============================================================
  console.log('=== 5. Gerando reclamacoes (~470) ===');
  ...
  // ============================================================
  console.log('=== 6. Gerando auditoria (~1000) ===');
  ...
  // 7. ATENDIMENTOS (~50)
  // ============================================================
  console.log('=== 7. Gerando atendimentos (~280) ===');
