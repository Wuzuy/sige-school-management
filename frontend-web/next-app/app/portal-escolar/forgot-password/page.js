    ...
    <div>
      ...
      <div className="recovery-container">
        ...
        <div className="back-link">
          <Link href="/portal-escolar/login">← Voltar ao Login</Link>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .btn-submit { width: 100%; padding: 14px; background: linear-gradient(135deg, #003366 0%, #0066cc 100%); color: white; border: none; border-radius: 8px; font-size: 16px; font-weight: 600; cursor: pointer; transition: transform 0.2s, box-shadow 0.2s; }
