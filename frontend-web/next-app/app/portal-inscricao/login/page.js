...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (user) {
      router.replace('/portal-inscricao');
      return;
    }
  }, [user, router]);
    ...
    <div>
      ...
      <main className="container">
        <section className="hero">
          ...
          <p>Portal de Inscrição — Processo seletivo e matrícula.</p>
        </section>
        ...
        <section className="grid">
          <article className="card card-6">
            ...
            <form onSubmit={handleLogin} className={mode !== 'login' ? 'hidden' : ''}>
              <div className="field">
              ...
              <div style={{ textAlign: 'right', marginTop: '-8px', marginBottom: '12px' }}>
                <Link href="/portal-inscricao/forgot-password" style={{ fontSize: '13px', color: '#003366' }}>Esqueci minha senha</Link>
              </div>
            ...
            <form onSubmit={handleRegister} className={mode !== 'register' ? 'hidden' : ''}>
              <div className="field">
          ...
          <div className="card">
            <Link href="/portal-inscricao/credits"><h2>Créditos</h2></Link>
          </div>
        </section>
      </main>
    </div>
